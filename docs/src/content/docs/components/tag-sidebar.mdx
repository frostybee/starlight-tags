...
| `title` | <code>string &#124; Record&lt;string, string&gt;</code> | `'Popular Tags'` translated into English, French, Spanish and German | Section heading |
...
<Default {...Astro.props} />
<TagSidebar limit={8} sortBy="count" {locale} />
```
