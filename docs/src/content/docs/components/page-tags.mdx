...
2. Fetches tag data from the [virtual tags module](/guides/virtual-tags-module) (memoized for efficiency)
...
Choose [`PageWithTags`](/components/page-with-tags) when you need:
