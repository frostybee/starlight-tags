...
- **Automatic data fetching** - reads from frontmatter or accepts `tagIds`
...
- **Custom tag selection** - Specify which tags to display via `tagIds`
...
- **Inline display** - Tags as part of content flow
