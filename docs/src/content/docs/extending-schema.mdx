...
- **[See the live demo](/demos/extended-schema)** - Working example with product documentation fields
- Learn about the [core tag properties](/tags-definition)
- See how to use [components](/components) to display tags
- Understand the [auto-generated routes](/routes)
