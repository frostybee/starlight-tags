...
- **YAML Parsing** - Converts YAML to JavaScript objects
- **Schema Validation** - Validates against Zod schemas
- **Page Collection** - Scans content files for tag references
- **URL Generation** - Creates slugs and URLs for each tag
