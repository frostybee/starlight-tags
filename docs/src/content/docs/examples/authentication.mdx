...
For applications that act on behalf of users. See [OAuth 2.0 Flow](/examples/oauth2-flow) for implementation details.
...
4. **Restrict key permissions** - Only grant necessary scopes
