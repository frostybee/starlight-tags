...
This page has `components`, `example`, and `getting-started` tags defined in its frontmatter. The demos below read these tags automatically.
:::
...
See the [PageTags documentation](/starlight-tags/components/page-tags/) for full API reference.
