...
export const translations = {
  ...
  ru: {
    'starlightTags.totalTags': 'Всего тегов',
    'starlightTags.pagesTagged': 'Страниц с тегами',
    'starlightTags.tagCloud': 'Облако тегов',
    'starlightTags.alphabeticalIndex': 'Алфавитный указатель',
    'starlightTags.allTags': 'Все теги',
    'starlightTags.page': 'Страница',
    'starlightTags.pages': 'Страницы',
    'starlightTags.pageTags': 'Теги:',
    'starlightTags.taggedPrefix': 'С тегом:',
    'starlightTags.relatedTags': 'Похожие теги',
    'starlightTags.pagesWithTag': 'Страницы с этим тегом',
    'starlightTags.related': 'Связанное',
    'starlightTags.path': 'Путь:',
    'starlightTags.pagination.label': 'Пагинация',
    'starlightTags.pagination.page': 'Страница',
    'starlightTags.pagination.of': '/',
    'starlightTags.pagination.previous': 'Предыдущая страница',
    'starlightTags.pagination.next': 'Следующая страница',
    'starlightTags.pagination.item': 'Элемент с тегом',
    'starlightTags.pagination.items': 'Элементы с тегом',
    'starlightTags.popularTags': 'Популярные теги',
    'starlightTags.viewAllTags': 'Просмотр всех тегов',
  },
} as const;
